...
import { formatNumber, formatRuntime, getRelativeTime, useUserStats } from '../hooks/useAnalytics';
  ...
  return (
    <div className='chart-container'>
      ...
      <div className='mb-6'>
        <ResponsiveContainer width='100%' height={300}>
          <BarChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <Bar dataKey='playCount' fill='#aa5cc8' radius={[4, 4, 0, 0]} name='Play Count' />
          </BarChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className='space-y-3 max-h-64 overflow-y-auto'>
        <div className='text-sm font-medium text-gray-400 px-2'>Detailed Statistics</div>
          ...
          >
            ...
            <div className='text-right'>
              <div className='flex items-center space-x-4'>
                ...
                <div className='text-center'>
                  <div className='text-white font-semibold'>{formatRuntime(user.totalRuntime)}</div>
        ...
        <div className='grid grid-cols-3 gap-4'>
          <div className='text-center'>
            <div className='text-2xl font-bold text-jellyfin-purple'>
              {formatNumber(
                userStats.mostActiveUsers.reduce((sum, user) => sum + user.playCount, 0),
              )}
            </div>
          ...
          <div className='text-center'>
            <div className='text-2xl font-bold text-green-400'>
              {Math.round(
                (userStats.mostActiveUsers.reduce((sum, user) => sum + user.totalRuntime, 0) /
                  3600 /
                  userStats.mostActiveUsers.length) *
                  10,
              ) / 10}
              h
            </div>
